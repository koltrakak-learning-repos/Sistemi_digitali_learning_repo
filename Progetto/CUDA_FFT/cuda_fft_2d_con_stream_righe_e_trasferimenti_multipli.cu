...
int main(int argc, char **argv) {
    ...
    complex* complex_input_image_data;
    cudaMallocHost((complex**)&complex_input_image_data, sizeof(complex)*image_size);
    ...
    cudaFreeHost(complex_input_image_data);
    free(output_image_data);
    cudaFreeHost(gpu_ref_output_fft_2D_data);
