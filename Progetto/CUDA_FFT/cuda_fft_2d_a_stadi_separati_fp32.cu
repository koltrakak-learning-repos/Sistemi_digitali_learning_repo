...
double fft_2D_cuda(complex *input_image_data, complex *output_fft_2D_data, int imageSize, int row_size, int column_size) {
    ...
    /*
        SE FACESSI COSÌ ESEGUIREI LE FFT IN MANIERA SEQUENZIALE!!!
        fft_iterativa_cuda(); È SINCRONA! or is it...

        Prova a vedere se il default stream mi salva  
    */
